...
//void mainWin::reply_ota_post_win(QNetworkReply *reply)
//{
//    //获取响应的信息，状态码为200表示正常
...
//    delete reply;
//}
//void mainWin::post_p310_ota_win(QString token,QString eid,QString imsi, QString newMSISDN)
//{
...
//  connect(g_network_manager,SIGNAL(finished(QNetworkReply*)), this, SLOT(reply_ota_post_win(QNetworkReply*)));

//  //发送请求
//  g_network_manager->post(network_request, post_data);
//}

//void mainWin::post_p310_win(QString eid,QString imsi)
//{
//    QString token = "2313897698789798";
//    QString newMSISDN = "213213789879897";
//    post_p310_ota_win(token, eid, imsi,newMSISDN);
//}
